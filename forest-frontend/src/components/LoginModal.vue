  ...
  >
    <template #header>
      <div class="modal-header">
        ...
        <p>{{ mode === 'login' ? '登录深林知识库中心' : '立即注册，开启智能知识服务' }}</p>
      </div>
    </template>
...
.input-group input:focus {
  ...
  box-shadow: 0 0 0 3px rgba(30, 78, 124, 0.1);
}
...
.btn-submit {
  ...
  font-weight: 600;
  transition: all 0.2s ease;
  box-shadow: 0 4px 14px rgba(30, 78, 124, 0.25);
  margin-top: 4px;
}
.btn-submit:hover:not(:disabled) {
  box-shadow: 0 6px 20px rgba(30, 78, 124, 0.35);
