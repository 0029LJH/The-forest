...
class RerankerModelSettings(BaseSettings):
...
class AuthSettings(BaseSettings):
    ...
    refresh_cookie_name: str = "forest_DD_RAG_REFRESH_TOKEN"
...
class MinioSettings(BaseSettings):
    ...
    bucket: str = "forest-rag-documents"
    secure: bool = False
...
class Settings(BaseSettings):
    ...
    reranker: RerankerModelSettings = Field(default_factory=RerankerModelSettings)
